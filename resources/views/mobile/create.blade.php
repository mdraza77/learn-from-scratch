        ...
        <div class="card p-4 shadow" style="min-height: 400px">
            <form action="{{ route('mobiles.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="operating_system" id="operating_system">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="number" name="storage_capacity" id="storage_capacity">
                ...
                <div class="mb-3"><label for="ram">RAM (GB)</label>
                    <input class="form-control" type="number" name="ram" id="ram">
                    @error('ram')
                        <small style="color: red;">{{ $message }}</small>
                    @enderror
                </div>
